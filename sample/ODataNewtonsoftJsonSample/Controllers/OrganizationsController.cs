...
namespace ODataRoutingSample.Controllers.v1
{
    ...
    {
        private static readonly Dictionary<int, Organization> organizations = new Dictionary<int, Organization>();
        ...
        public IActionResult Post([FromBody] Organization org)
        {
            ...
            */
            ...
            do
            {
                org.OrganizationId = random.Next();
            }
            while (!organizations.TryAdd(org.OrganizationId, org));

            return Ok(org);
        }

        [HttpGet("Organizations/{key}")]
