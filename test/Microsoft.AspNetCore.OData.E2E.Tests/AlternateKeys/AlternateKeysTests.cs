...
using Microsoft.AspNetCore.OData.E2E.Tests.AlternateKeys;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class AlternateKeysTests : WebApiTestBase<AlternateKeysTests>
    {

        public AlternateKeysTests(WebApiTestFixture<AlternateKeysTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
            base.ConfigureServicesAction = (IServiceCollection services) =>
            {
                var controllers = new[]
                {
