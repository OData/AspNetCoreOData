...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class UriParserExtension_CaseInsensitiveTests : WebApiTestBase<UriParserExtension_CaseInsensitiveTests>
    {

        public UriParserExtension_CaseInsensitiveTests(WebApiTestFixture<UriParserExtension_CaseInsensitiveTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        ...
        public async Task EnableCaseInsensitiveTest(string method, string caseSensitive, string caseInsensitive)
        {
            ...
            Output.WriteLine($"Case Sensitive: {caseSensitiveResponse}");
            ...
            Output.WriteLine($"Case Insensitive: {caseInsensitiveResponse}");
