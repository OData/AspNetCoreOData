...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class UriParserExtension_UnqualifiedCallTests : WebApiTestBase<UriParserExtension_UnqualifiedCallTests>
    {

        public UriParserExtension_UnqualifiedCallTests(WebApiTestFixture<UriParserExtension_UnqualifiedCallTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
