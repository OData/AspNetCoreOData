...
using Microsoft.AspNetCore.OData.E2E.Tests.NavigationPropertyOnComplexType;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class NavigationProperties_SelectImprovementOnComplexTypeTests : WebApiTestBase<NavigationProperties_SelectImprovementOnComplexTypeTests>
    {

        private const string PeopleBaseUrl = "odata/People";

        public NavigationProperties_SelectImprovementOnComplexTypeTests(WebApiTestFixture<NavigationProperties_SelectImprovementOnComplexTypeTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
