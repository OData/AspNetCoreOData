...
using Microsoft.AspNetCore.OData.E2E.Tests.Cast;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class CastTests : WebApiTestBase<CastTests>
    {

        private static string[] dataSourceTypes = new string[] { "IM", "EF" };// In Memory and Entity Framework

        public CastTests(WebApiTestFixture<CastTests> fixture, ITestOutputHelper output)
            :base(fixture, output)
        {
