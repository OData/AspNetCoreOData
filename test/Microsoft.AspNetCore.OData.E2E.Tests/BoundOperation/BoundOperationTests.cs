...
using Microsoft.AspNetCore.OData.E2E.Tests.BoundOperation;
...
{
    public class BoundOperationTests : WebApiTestBase<BoundOperationTests>
    {
        ...
        public BoundOperationTests(WebApiTestFixture<BoundOperationTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        ...
        */
        ...
        public async Task ActionBountToEntitySet(string url, int expectedCount)
        {
            ...
            //Act
            HttpResponseMessage responseForPost = await CreateClient().SendAsync(requestForPost);
