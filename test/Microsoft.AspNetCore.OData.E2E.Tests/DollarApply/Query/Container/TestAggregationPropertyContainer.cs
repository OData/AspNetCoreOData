...
{
    internal class TestAggregationPropertyContainer : IAggregationPropertyContainer<TestGroupByWrapper>
    {
        ...
        public IAggregationPropertyContainer<TestGroupByWrapper> Next { get; set; }
