...
using Microsoft.AspNetCore.OData.E2E.Tests.ETags;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class ETags_CRUDWithIfMatchTests : WebApiTestBase<ETags_CRUDWithIfMatchTests>
    {

        public ETags_CRUDWithIfMatchTests(WebApiTestFixture<ETags_CRUDWithIfMatchTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
