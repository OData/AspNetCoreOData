...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class ETags_DerivedTests : WebApiTestBase<ETags_DerivedTests>
    {

        public ETags_DerivedTests(WebApiTestFixture<ETags_DerivedTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
