...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class ETags_UntypedTests : WebApiTestBase<ETags_UntypedTests>
    {

        public ETags_UntypedTests(WebApiTestFixture<ETags_UntypedTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
