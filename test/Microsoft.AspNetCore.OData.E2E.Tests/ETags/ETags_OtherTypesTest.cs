...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class ETags_OtherTypesTest : WebApiTestBase<ETags_OtherTypesTest>
    {

        public ETags_OtherTypesTest(WebApiTestFixture<ETags_OtherTypesTest> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
