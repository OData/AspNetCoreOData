...
using Microsoft.AspNetCore.OData.E2E.Tests.UnboundOperation;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class UnboundOperationTests : WebApiTestBase<UnboundOperationTests>
    {

        public UnboundOperationTests(WebApiTestFixture<UnboundOperationTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
