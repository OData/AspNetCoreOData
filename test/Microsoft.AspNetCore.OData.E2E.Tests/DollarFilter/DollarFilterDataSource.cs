...
public class DollarFilterDataSource
{
    ...
    static DollarFilterDataSource()
    {
        ...
        var literalInfo = new LiteralInfo
        {
            ...
            DeclaredTimeOnlyProperty = new TimeOnly(23, 59, 59, 0),
            DeclaredDateOnlyProperty = new DateOnly(1970, 1, 1),
            ...
            DynamicProperties = new Dictionary<string, object>
            {
                ...
                { "DynamicTimeOnlyProperty", new TimeOnly(23, 59, 59, 0) },
                { "DynamicDateOnlyProperty", new DateOnly(1970, 1, 1) },
