...
public class DollarFilterDataSource
{
    ...
    static DollarFilterDataSource()
    {
        ...
        var literalInfo = new LiteralInfo
        {
            ...
            DeclaredTimeOfDayProperty = new TimeOfDay(23, 59, 59, 0),
            DeclaredDateProperty = new Date(1970, 1, 1),
            ...
            DynamicProperties = new Dictionary<string, object>
            {
                ...
                { "DynamicTimeOfDayProperty", new TimeOfDay(23, 59, 59, 0) },
                { "DynamicDateProperty", new Microsoft.OData.Edm.Date(1970, 1, 1) },
