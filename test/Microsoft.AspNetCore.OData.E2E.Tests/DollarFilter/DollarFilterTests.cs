...
public class DollarFilterTests : WebApiTestBase<DollarFilterTests>
{
    ...
    [InlineData("DeclaredLiteralInfo/DeclaredTimeOnlyProperty eq 23:59:59.0000000")]
    [InlineData("DeclaredLiteralInfo/DeclaredDateOnlyProperty eq 1970-01-01")]
    ...
    [InlineData("DeclaredLiteralInfo/DynamicTimeOnlyProperty eq 23:59:59.0000000")]
    [InlineData("DeclaredLiteralInfo/DynamicDateOnlyProperty eq 1970-01-01")]
    ...
    [InlineData("DeclaredLiteralInfos/any(d:d/DeclaredTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DeclaredLiteralInfos/any(d:d/DeclaredDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DeclaredLiteralInfos/any(d:d/DynamicTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DeclaredLiteralInfos/any(d:d/DynamicDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DeclaredLiteralInfos/all(d:d/DeclaredTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DeclaredLiteralInfos/all(d:d/DeclaredDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DeclaredLiteralInfos/all(d:d/DynamicTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DeclaredLiteralInfos/all(d:d/DynamicDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DynamicLiteralInfo/DeclaredTimeOnlyProperty eq 23:59:59.0000000")]
    [InlineData("DynamicLiteralInfo/DeclaredDateOnlyProperty eq 1970-01-01")]
    ...
    [InlineData("DynamicLiteralInfo/DynamicTimeOnlyProperty eq 23:59:59.0000000")]
    [InlineData("DynamicLiteralInfo/DynamicDateOnlyProperty eq 1970-01-01")]
    ...
    [InlineData("DynamicLiteralInfos/any(d:d/DeclaredTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DynamicLiteralInfos/any(d:d/DeclaredDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DynamicLiteralInfos/any(d:d/DynamicTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DynamicLiteralInfos/any(d:d/DynamicDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DynamicLiteralInfos/all(d:d/DeclaredTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DynamicLiteralInfos/all(d:d/DeclaredDateOnlyProperty eq 1970-01-01)")]
    ...
    [InlineData("DynamicLiteralInfos/all(d:d/DynamicTimeOnlyProperty eq 23:59:59.0000000)")]
    [InlineData("DynamicLiteralInfos/all(d:d/DynamicDateOnlyProperty eq 1970-01-01)")]
