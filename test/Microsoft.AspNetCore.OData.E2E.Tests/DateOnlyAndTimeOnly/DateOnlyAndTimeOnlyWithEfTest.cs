...
"</edmx:Edmx>";
  ...
  ""EndTime"": null
    ...
    [InlineData("?$filter=DateOnly le 2015-12-23", "1,2,4")]
    [InlineData("?$filter=DateOnly ge 2015-12-23", "1,3,5")]
    ...
    [InlineData("?$filter=TimeOnly le 11:30:00", "1,2,4,5")]
    [InlineData("?$filter=TimeOnly ge 11:30:00", "1,3,5")]
