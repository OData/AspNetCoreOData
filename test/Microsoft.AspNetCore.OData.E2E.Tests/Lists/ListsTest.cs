    ...
    public class ListsTest : WebApiTestBase<ListsTest>
    {
        ...
        public async Task QueryEntitySet(string format)
        {
            ...
            if (format == "application/json;odata.metadata=full")
            {
                ...
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestString)", typeOfListTestString);

                var typeOfListTestBool = results[0]["ListTestBool@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestBool)", typeOfListTestBool);

                var typeOfListTestFloat = results[0]["ListTestFloat@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestFloat)", typeOfListTestFloat);

                var typeOfListTestDouble = results[0]["ListTestDouble@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestDouble)", typeOfListTestDouble);

                var typeOfListTestInt = results[0]["ListTestInt@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestInt)", typeOfListTestInt);

                var typeOfListTestUint = results[0]["ListTestUint@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestUint)", typeOfListTestUint);

                var typeOfListTestUri = results[0]["ListTestUri@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestUri)", typeOfListTestUri);
            }
        }
        ...
        public async Task QueryEntity(string format)
        {
            ...
            if (format == "application/json;odata.metadata=full")
            {
                ...
                var typeOfListTestUint = result["ListTestUint@odata.type"].ToString();
                Assert.Equal("#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.ListTestUint)", typeOfListTestUint);
        ...
        //[InlineData("/convention/Employees(1)/SkillSet/$count?$filter=$it eq Microsoft.AspNetCore.OData.E2E.Tests.Lists.Skill'Sql'", 1)]
        ...
        //        Assert.True(context.IndexOf("/$metadata#Collection(Microsoft.AspNetCore.OData.E2E.Tests.Lists.Skill)") >= 0);
        //    }
        //}
        ...
        //{
        //    // Arrange
        //    string postUri = "/convention/Employees(6)/Microsoft.AspNetCore.OData.E2E.Tests.Lists.AddSkill";
        ...
        //    // Arrange
        //    HttpClient client = CreateClient();
        //    var getUri = "/convention/Employees(9)/Microsoft.AspNetCore.OData.E2E.Tests.Lists.FindAccessLevel()";
        ...
        //[Theory]
        //[InlineData("/convention/HasAccessLevel(ID=1,AccessLevel=Microsoft.AspNetCore.OData.E2E.Tests.Lists.AccessLevel'Read')", false)]
        //[InlineData("/convention/HasAccessLevel(ID=2,AccessLevel=Microsoft.AspNetCore.OData.E2E.Tests.Lists.AccessLevel'1')", true)]
