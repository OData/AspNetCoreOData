...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    /// 
    /// </summary>
    public class DateAndTimeOfDayTests : WebApiTestBase<DateAndTimeOfDayTests>
    {
        ...
        public DateAndTimeOfDayTests(WebApiTestFixture<DateAndTimeOfDayTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        ...
        {
            string requestUri = $"{modelMode}/$metadata";
        ...
        {
            string requestUri = $"{mode}/DCustomers(2)?$format={mime}";
        ...
        public async Task CanCallFunctionWithDateAndTimeOfDayParameters(string mode, string function)
        {
            ...
            string requestUri = string.Format("{0}/{1}({2})", mode, function, parameter);
            HttpClient client = CreateClient();
        ...
        {
            string requestUri = $"convention/EfCustomers(2)?$format={mime}";
        ...
        {
            var requestUriForPost = mode + "/ResetDataSource";
            HttpClient client = CreateClient();
