...
using Microsoft.AspNetCore.OData.E2E.Tests.DateTimeOffsetSupport;
...
{
    public class DateTimeOffsetTests : WebApiTestBase<DateTimeOffsetTests>
    {

        #region Constructors

        public DateTimeOffsetTests(WebApiTestFixture<DateTimeOffsetTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
