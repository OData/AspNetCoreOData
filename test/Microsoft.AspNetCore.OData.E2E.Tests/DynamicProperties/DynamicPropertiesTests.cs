...
using Microsoft.AspNetCore.OData.E2E.Tests.DynamicProperties;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    public class DynamicPropertiesTests : WebApiTestBase<DynamicPropertiesTests>
    {

        public DynamicPropertiesTests(WebApiTestFixture<DynamicPropertiesTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
            ConfigureServicesAction = (IServiceCollection services) =>
            {
                services.ConfigureControllers(typeof(DynamicCustomersController), typeof(DynamicSingleCustomerController));
