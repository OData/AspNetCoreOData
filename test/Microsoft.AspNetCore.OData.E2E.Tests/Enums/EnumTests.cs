...
using Microsoft.AspNetCore.OData.E2E.Tests.Enums;
...
namespace Microsoft.AspNetCore.OData.E2E.Tests
{
    ...
    /// 
    /// </summary>
    public class EnumTests : WebApiTestBase<EnumTests>
    {
        ...
        public EnumTests(WebApiTestFixture<EnumTests> fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
...
#region Update
        ...
        //    using (HttpResponseMessage response = await CreateClient().GetAsync(requestUri))
        //    {
        //        response.EnsureSuccessStatusCode();
