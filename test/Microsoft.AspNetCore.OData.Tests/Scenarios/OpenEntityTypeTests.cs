//-----------------------------------------------------------------------------
// <copyright file="OpenEntityTypeTests.cs" company=".NET Foundation">
...
public class OpenEntityTypeTests
{
    ...
    [Fact]
    public async Task Get_OpenEntityType()
    {
        // Arrange
        ...
        Assert.Equal("http://localhost/odata/$metadata#SimpleOpenCustomers/Microsoft.AspNetCore.OData.Tests.Models.SimpleVipCustomer/$entity", result["@odata.context"]);
        Assert.Equal("#Microsoft.AspNetCore.OData.Tests.Models.SimpleVipCustomer", result["@odata.type"]);
    ...
    public async Task Get_OpenEntityType_Enum_Collection_Property()
    {
        ...
        var client = GetClient(GetUntypedEdmModel(), typeof(UntypedSimpleOpenCustomersController));
