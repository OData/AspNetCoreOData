...
namespace Microsoft.AspNetCore.OData.Tests.Query
{
    public class ParameterAliasNodeTranslatorTest
    {
        ...
        {
            // Arrange & Act & Assert
            ExceptionAssert.ThrowsArgumentNull(() => new ParameterAliasNodeTranslator(null), "parameterAliasNodes");
        }
        ...
        {
            // Arrange & Act
            QueryNode translatedNode = TranslateFilterExpression("Default.SingleEntityFunctionCall(p1=@p)/Addresses/Microsoft.AspNetCore.OData.Tests.Query.ParameterAliasAddress/all(a : a ne null)");
        ...
        {
            // Arrange & Act
            QueryNode translatedNode = TranslateFilterExpression("Default.SingleEntityFunctionCall(p1=@p)/Orders/Microsoft.AspNetCore.OData.Tests.Query.ParameterAliasOrder/all(o : o ne null)");
        ...
        {
            // Arrange & Act
            QueryNode translatedNode = TranslateFilterExpression("Default.SingleEntityFunctionCall(p1=@p)/Microsoft.AspNetCore.OData.Tests.Query.ParameterAliasCustomer eq null");
        ...
        {
            // Arrange & Act
            QueryNode translatedNode = TranslateFilterExpression("Default.SingleEntityFunctionCall(p1=@p)/SpecialAddress/Microsoft.AspNetCore.OData.Tests.Query.ParameterAliasAddress eq null");
