//-----------------------------------------------------------------------------
// <copyright file="EdmStructuredObjectTests.cs" company=".NET Foundation">
    ...
    public static TheoryDataSet<IEdmTypeReference, object> GetDefaultValueTestData
    {
        get
        {
            ...
            return new TheoryDataSet<IEdmTypeReference, object>
            {
                ...
                { EdmCoreModel.Instance.GetPrimitive(EdmPrimitiveTypeKind.Date, isNullable: false), default(DateOnly) },
                { EdmCoreModel.Instance.GetPrimitive(EdmPrimitiveTypeKind.TimeOfDay, isNullable: true), null },
                { EdmCoreModel.Instance.GetPrimitive(EdmPrimitiveTypeKind.TimeOfDay, isNullable: false), default(TimeOnly) },
