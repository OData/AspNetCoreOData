//-----------------------------------------------------------------------------
// <copyright file="FilterSegmentTemplate.cs" company=".NET Foundation">
...
namespace Microsoft.AspNetCore.OData.Routing.Template
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FilterSegmentTemplate" /> class.
        /// </summary>
        /// <param name="segment">The singleton segment.</param>
        public FilterSegmentTemplate(FilterSegment segment)
        {
        ...
        /// </summary>
        public FilterSegment Segment { get; }
