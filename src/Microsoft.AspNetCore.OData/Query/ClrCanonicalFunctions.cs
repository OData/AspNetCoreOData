...
internal class ClrCanonicalFunctions
{
    ...
    public static readonly MethodInfo MatchesPatternWithTimeout = MethodOf(_ => Regex.IsMatch(default(string), default(string), default(RegexOptions), default(TimeSpan)));
