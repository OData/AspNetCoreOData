...
public interface IApplyQueryValidator
{
    ...
    /// <summary>
    /// Attempts to validate the <see cref="ApplyQueryOption" />.
    /// </summary>
    /// <param name="applyQueryOption">The $apply query.</param>
    /// <param name="validationSettings">The validation settings.</param>
    ...
    bool TryValidate(ApplyQueryOption applyQueryOption, ODataValidationSettings validationSettings, out IEnumerable<string> validationErrors);
}
