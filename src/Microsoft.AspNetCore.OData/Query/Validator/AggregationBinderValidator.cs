//-----------------------------------------------------------------------------
// <copyright file="AggregationBinderValidator.cs" company=".NET Foundation">
...
{
    /// <summary>
    /// Represents a validator used to validate the results of translating an OData $apply parse tree into expressions.
    /// </summary>
    internal static class AggregationBinderValidator
    {
        private static readonly Type groupByWrapperInterfaceTypeOfT = typeof(IGroupByWrapper<>);
        private static string groupByWrapperInterfaceTypeOfTName = $"{groupByWrapperInterfaceTypeOfT.Namespace}.{groupByWrapperInterfaceTypeOfT.Name.Split('`')[0]}{{T}}";
        ...
        /// implements <see cref="IGroupByWrapper{T}"/> and derives from <see cref="DynamicTypeWrapper"/>.
        /// </summary>
        ...
        /// <summary>
        /// Validates that the provided type implements <see cref="IGroupByWrapper{T}"/> and <see cref="IFlatteningWrapper{T}"/>, and inherits from <see cref="DynamicTypeWrapper"/>.
        /// </summary>
        ...
        /// <summary>
        /// Validates that the provided type implements <see cref="IGroupByWrapper{T}"/> and inherits from <see cref="DynamicTypeWrapper"/>.
        /// </summary>
        ...
        {
            // Type must implement IGroupByWrapper<T> interface
