...
namespace Microsoft.AspNetCore.OData.Query.Container
{
    ...
    /// </summary>
    /// <typeparam name="T">The type that declares a member of this type. Type T must implement <see cref="IGroupByWrapper{T}"/>.</typeparam>
    /// <remarks>
    /// When we have $apply=groupby((Prop1,Prop2,Prop3))&amp;$orderby=Prop1,Prop2
    /// where <see cref="AggregationPropertyContainer"/> implements <see cref="IAggregationPropertyContainer{T}"/>,
    ...
    /// </remarks>
    public interface IAggregationPropertyContainer<T>
    {
        ...
        IAggregationPropertyContainer<T> Next { get; set; }
