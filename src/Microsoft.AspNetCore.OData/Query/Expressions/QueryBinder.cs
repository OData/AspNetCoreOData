...
namespace Microsoft.AspNetCore.OData.Query.Expressions
{
    ...
    public abstract partial class QueryBinder
    {
        ...
        private static MemberInitExpression ExtractContainerExpression(MethodCallExpression expression, string containerName)
        {
            ...
            {
                var containerAssignment = memberInitExpression.Bindings.FirstOrDefault(m => m.Member.Name == containerName) as MemberAssignment;
            ...
            QueryBinderContext context)
        {
            ...
            MethodInfo getEdmTypeReferenceMethod = typeof(EdmClrTypeMapExtensions).GetMethod(
                name: nameof(EdmClrTypeMapExtensions.GetEdmTypeReference),
                bindingAttr: BindingFlags.Public | BindingFlags.Static,
                binder: null,
                types: new[] { typeof(IEdmModel), typeof(Type) },
                modifiers: null);
            ...
            MethodInfo getDynamicPropertyContainerMethod = typeof(QueryBinder).GetMethod(
                name: nameof(GetDynamicPropertyContainer),
                bindingAttr: BindingFlags.NonPublic | BindingFlags.Static,
                binder: null,
                types: new[] { typeof(IEdmTypeReference), typeof(QueryNodeKind), typeof(IEdmModel) },
                modifiers: null);
