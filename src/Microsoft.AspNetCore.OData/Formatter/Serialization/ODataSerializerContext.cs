...
public class ODataSerializerContext
{
    ...
    public ODataSerializerContext(ResourceContext resourceContext, SelectExpandClause selectExpandClause, IEdmProperty edmProperty)
        : this(resourceContext, edmProperty, null, null)
    {
