...
namespace Microsoft.AspNetCore.OData.Formatter.Deserialization
{
    ...
    public class ODataResourceDeserializer : ODataEdmTypeDeserializer
    {
            ...
            ODataResourceSetWrapper resourceSetWrapper, ODataDeserializerContext readContext)
        {
            ...
            // If the property is declared as "Collection(Edm.Untyped)" and its value is a resource set,
            // Let's switch to use Collection of 'EdmUntypedStructuredTypeReference'.
            IEdmTypeReference edmType = nestedProperty.Type;
            var elementType = nestedProperty.Type.AsCollection().ElementType();
            ...
            ODataResourceSetWrapper resourceSetWrapper, ODataDeserializerContext readContext)
        {
            ...
            if (string.IsNullOrEmpty(resourceSetWrapper.ResourceSet.TypeName) ||
                string.Equals(resourceSetWrapper.ResourceSet.TypeName, "Collection(Edm.Untyped)", StringComparison.OrdinalIgnoreCase))
            {
