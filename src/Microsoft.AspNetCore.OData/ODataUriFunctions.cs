...
public static class ODataUriFunctions
{
    ...
    public static void AddCustomUriFunction(IEdmModel model, string functionName,
        FunctionSignatureWithReturnType functionSignature, MethodInfo methodInfo)
    {
        ...
        catch
        {
            ...
            RemoveCustomUriFunction(model, functionName, functionSignature, methodInfo);
            throw;
        }
    }
    ...
    public static bool RemoveCustomUriFunction(IEdmModel model, string functionName,
        FunctionSignatureWithReturnType functionSignature, MethodInfo methodInfo)
    {
        return
