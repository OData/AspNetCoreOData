...
namespace QueryBuilder.Formatter.Deserialization
{
    internal static class DeserializationHelpers
    {
        ...
        internal static void SetDynamicProperty(object resource, IEdmStructuredTypeReference resourceType,
            ...
            IEdmModel model)
        {
            if (propertyKind == EdmTypeKind.Collection && propertyValue.GetType() != typeof(EdmComplexObjectCollection) // QUESTION: These are defined in Microsoft.AspNetCore.OData.Formatter.Value, but not this repo. Why?
