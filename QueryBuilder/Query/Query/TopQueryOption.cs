...
namespace QueryBuilder.Query
{
    ...
    public class TopQueryOption
    {
        ...
        public TopQueryOption(string rawValue, ODataQueryFundamentalsContext context, ODataQueryOptionParser queryOptionParser)
        {
            if (context == null)
            {
            ...
            Context = context;
            RawValue = rawValue;
            Validator = context.Validators.GetTopQueryValidator();
            _queryOptionParser = queryOptionParser;
        }

        // This constructor is intended for unit testing only.
        internal TopQueryOption(string rawValue, ODataQueryFundamentalsContext context)
        {
            if (context == null)
            {
                throw Error.ArgumentNull(nameof(context));
