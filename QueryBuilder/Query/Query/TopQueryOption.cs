...
namespace QueryBuilder.Query
{
    ...
    public class TopQueryOption
    {
        ...
        public TopQueryOption(string rawValue, ODataQueryContext2 context, ODataQueryOptionParser queryOptionParser)
        {
            if (context == null)
            {
        ...
        internal TopQueryOption(string rawValue, ODataQueryContext2 context)
        {
            if (context == null)
            {
                throw Error.ArgumentNull(nameof(context));
