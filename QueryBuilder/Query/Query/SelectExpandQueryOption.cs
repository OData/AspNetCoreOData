...
namespace QueryBuilder.Query
{
    ...
    public class SelectExpandQueryOption
    {
        ...
        public IQueryable ApplyTo(IQueryable queryable, ODataQuerySettings settings, ISelectExpandBinder binder)
        {
            if (queryable == null)
            {
        ...
        public object ApplyTo(object entity, ODataQuerySettings settings, ISelectExpandBinder binder)
        {
            if (entity == null)
            {
